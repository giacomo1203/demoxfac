                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/4b459cb7e2b9fc29f83d2344f/images/44af9f7a-d98d-44de-a41c-ad6bcc32e153.png" width="300" style="max-width:300px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h2 style="text-align: center;">Bienvenido Nestor</h2>

<p style="font-size: 18px !important; text-align: center;"><span style="color:#000000">Tus accesos son los siguientes:&nbsp;</span><br>
<br>
<span style="color:#00add8"><strong>RUC: 10473232672<br>
PASS: 39dkvi40</strong></span><br>
<br>
<span style="color:#000000">Haz click en el siguiente botón para activar tu cuenta.</span></p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Validar Datos" href="http://www.xfactura.com" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Validar Datos</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<p style="text-align:center !important;">Puedes llamarnos a los siguientes números o contactarte al siguiente correo.<br>
soporte@xfactura.com<br>
999-999-999</p>
